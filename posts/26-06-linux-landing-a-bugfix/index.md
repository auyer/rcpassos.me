...
My first question was "*If the boot failed, how am I going to get the logs? Am I going into this completely blind?*"
...
Once we have a disk, *systemd-journal-flush.service* is activated, and flushes content from the tempfs to `/var/log/journal/` persistent storage.
...
There is a proper way to register a cleanup function. The review mentioned the *Wacom* drivers, and I used them as a reference.
