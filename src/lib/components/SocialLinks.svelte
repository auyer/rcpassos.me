...
{#if linkedin}
	<a href={`https://www.linkedin.com/in/${linkedin}`} class="social-link" aria-label="Follow on LinkedIn">
...
{#if bluesky}
	<a href={`https://bsky.app/profile/${bluesky}`} class="social-link" aria-label="Check me on BlueSky">
		<svg
			class="social-icon"
			style="height:1em;vertical-align:-.125em;transform-origin:center;overflow:visible"
			viewBox="0 0 640 512"
