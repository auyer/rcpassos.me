...
{#if xmpp}
	<a href={`${xmpp}`} class="group" aria-label="Contact me on XMPP">
		<svg
...
{#if github}
	<a href={`https://github.com/${github}`} class="group" aria-label="Follow on GitHub">
		<svg
			viewBox="0 0 24 24"
			aria-hidden="true"
			class="w-6 h-6 transition text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300"
		>
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
...
{#if linkedin}
	<a href={`https://www.linkedin.com/in/${linkedin}`} class="group" aria-label="Follow on LinkedIn">
		<svg
			viewBox="0 0 24 24"
			class="w-6 h-6 transition text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300"
		>
...
{#if stackoverflow}
	...
	>
		<svg
			class="svelte-fa w-6 h-6 transition text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300"
...
{#if bluesky}
	<a href={`https://bsky.app/profile/${bluesky}`} class="group" aria-label="Check me on BlueSky">
		<svg
			class="svelte-fa w-6 h-6 transition text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300"
			style="height:1em;vertical-align:-.125em;transform-origin:center;overflow:visible"
			viewBox="0 0 640 512"
...
{#if medium}
	<a href={`https://medium.com/${medium}`} class="group" aria-label="Check me on Medium">
		<svg
			class="svelte-fa w-6 h-6 transition text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300"
			style="height:1em;vertical-align:-.125em;transform-origin:center;overflow:visible"
			viewBox="0 0 640 512"
